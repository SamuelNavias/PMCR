---
title: "Probability, R, and Monte Carlo Simulation"
output:
...
These functions are useful in various applications, such as calculating percentiles or finding probabilities in a normal distribution.

Now I am adding new stuff and seeing if that makes it to the github
